...
- **ESSENTIAL:** Read `ai_docs/PRESENTATION_DESIGN_GUIDELINES.md` to understand all layout patterns, typography scales, color usage, spacing systems, and component standards before planning any slide feature.
